class YoutubeController < ApplicationController
  ...
  #     for google_api in 2..10 do
  #       youtube.key = ENV["YOUTUBE_#{google_api}"]
  #       if youtube_search_list = youtube.list_searches("id,snippet", type: "video", q: params[:keyword], max_results: 30) then
  #         youtube_search_list = youtube.list_searches("id,snippet", type: "video", q: params[:keyword], max_results: 30)
  #       else
  #         google_api += 1
  #       end
