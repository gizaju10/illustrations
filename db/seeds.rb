array = %w[知識 技術 メンタル その他カテゴリー 漫画家 イラストレーター キャラクターデザイナー コンセプトアーティスト アニメーター 絵本作家 その他職種 初心者 中級者 上級者 小学生以下 中学・高校生 専門・大学生
           社会人]
array.each do |tag|
...
Post.create('user_id' => '7', 'title' => '目の描き方がわかる！', 'url' => 'https://www.youtube.com/watch?v=XimUk5_O0mY',
            'category_list' => %w[知識 技術], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー アニメーター], 'target_list' => ['初心者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => "マンガなどのデフォルメされた目の描き方が学べる動画です。\r\n\r\n可愛い目が描きたい超初心者向けの内容となっています。")
Post.create('user_id' => '1', 'title' => '線画が苦手な全ての方へ', 'url' => 'https://www.youtube.com/watch?v=_J0ai2N1z9E',
            'category_list' => %w[知識 技術], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー アニメーター], 'target_list' => ['中級者', '中学・高校生', '専門・大学生', '社会人'], 'content' => "線画を描くことが嫌いだったのですが、この動画で線画のコツが分かりました。\r\n\r\n線画の苦手意識がある方に観てほしいです！")
Post.create('user_id' => '7', 'title' => '男女の描き分け方法が分かる', 'url' => 'https://www.youtube.com/watch?v=cXKh8VaMBdc',
            'category_list' => %w[知識 技術], 'occupation_list' => %w[イラストレーター キャラクターデザイナー アニメーター 絵本作家], 'target_list' => ['初心者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => '男女の描き方の違いが分かって描くときに参考になる動画です。')
Post.create('user_id' => '8', 'title' => '【初心者向け】体の描き方！覚えるのは３つだけ！【プロ漫画家イラスト漫画教室】',
            'url' => 'https://www.youtube.com/watch?v=A3fmnPufAyA', 'category_list' => %w[知識 技術], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー アニメーター 絵本作家], 'target_list' => ['初心者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => "凄く分かりやすく初心者向けに体の描き方が解説されています。\r\n\r\n基礎中の基礎の話なので、骨格や筋肉については端折られています。")
Post.create('user_id' => '2', 'title' => 'キャラクターを引き立てる！背景イラストの描き方', 'url' => 'https://www.youtube.com/watch?v=GWLvdIsHNRg',
            'category_list' => %w[知識 技術], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー コンセプトアーティスト アニメーター 絵本作家], 'target_list' => ['中級者', '中学・高校生', '専門・大学生', '社会人'], 'content' => "アナログでしかイラストを描いたことがなかったので、デジタルで描くことに抵抗がありましたが、デジタルの便利さに気付かされる動画でした。\r\n\r\n私のようにデジタルでイラストを描くことに抵抗がある方向けの動画です。")
Post.create('user_id' => '3', 'title' => '【油絵】「画家が本気で猫描いてみた」が凄いッ!!!', 'url' => 'https://www.youtube.com/watch?v=hBaIcKXeeEA',
            'category_list' => ['技術'], 'occupation_list' => %w[イラストレーター その他職種], 'target_list' => ['中級者', '上級者', '専門・大学生', '社会人'], 'content' => "技術も凄いですが、ただただ流し観しているだけでも感動するほど美しい動画です。\r\n\r\n毛や目の細部までの描き込みに惚れ惚れします。\r\n頑張るモチベーションになりました！")
Post.create('user_id' => '2', 'title' => '【イラスト制作の流れ】構図→塗りまでの流れ', 'url' => 'https://www.youtube.com/watch?v=24S7HX0Ds7s',
            'category_list' => ['技術'], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー アニメーター], 'target_list' => ['初心者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => 'プロでも写真を撮ってポーズを描いていると知って、面倒臭がらずやる事が大事なんだと思わされる動画でした。')
Post.create('user_id' => '1', 'title' => '奥行きがある絵の描き方と練習法を学ぶ', 'url' => 'https://www.youtube.com/watch?v=r6UPYLj20Js',
            'category_list' => ['技術'], 'occupation_list' => %w[漫画家 イラストレーター コンセプトアーティスト アニメーター 絵本作家], 'target_list' => ['初心者', '中級者', '中学・高校生', '専門・大学生', '社会人'], 'content' => "背景を描く時にパースばかりに気を取られていましたが、背景の描き方の奥深さを知れる動画でした。\r\n\r\n背景を描くことに行き詰まった時に観ると良いと思います。")
Post.create('user_id' => '2', 'title' => '100均のクレヨンでリアルな樹木が凄い!', 'url' => 'https://www.youtube.com/watch?v=cy89WHFKSyQ',
            'category_list' => ['技術'], 'occupation_list' => %w[コンセプトアーティスト アニメーター 絵本作家 その他職種], 'target_list' => %w[上級者 社会人], 'content' => "日頃アニメキャラクターのイラストを描いている時にふと、クレヨンで描きたくなって見つけた動画でしたが、100均のクレヨンでも極めればここまで繊細な表現ができることに驚きです！\r\n\r\nイラストは、紙とペンさえあれば始められる最高の趣味だと改めて感じることができました。")
Post.create('user_id' => '2', 'title' => '100均のクレヨンでリアルな夏の風景が凄い!', 'url' => 'https://www.youtube.com/watch?v=mnrjPDLGOSE',
            'category_list' => ['技術'], 'occupation_list' => %w[コンセプトアーティスト アニメーター 絵本作家 その他職種], 'target_list' => %w[上級者 社会人], 'content' => "クレヨンでの表現が素晴らしいです。\r\n\r\nこの100均クレヨンシリーズの動画をもっと観たいですね!")
Post.create('user_id' => '5', 'title' => 'この悩みはわかりすぎて辛い', 'url' => 'https://www.youtube.com/watch?v=CuVdgRWXFYY',
            'category_list' => ['メンタル'], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー コンセプトアーティスト アニメーター 絵本作家 その他職種], 'target_list' => ['中級者', '上級者', '専門・大学生', '社会人'], 'content' => 'スランプの時に観るといいと思います。')
Post.create('user_id' => '8', 'title' => 'アニメーションの作り方-動画の描き方', 'url' => 'https://www.youtube.com/watch?v=dJWdkyMo8gc',
            'category_list' => ['技術'], 'occupation_list' => ['アニメーター'], 'target_list' => ['初心者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => "初心者向けにイラストをアニメーションにするやり方を教えてくれています。\r\n動画時間も非常に短くて隙間時間に最適な動画です。")
Post.create('user_id' => '1', 'title' => '上手い絵を見て凹んでしまう人へ', 'url' => 'https://www.youtube.com/watch?v=X_28AjPPYj4',
            'category_list' => ['メンタル'], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー コンセプトアーティスト アニメーター 絵本作家 その他職種], 'target_list' => ['初心者', '中級者', '上級者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => "他人とすぐ比べて凹んでしまうことが悩みだったので、少し救われる動画でした。\r\n\r\n動画にもある様に、尾田先生や鳥山先生は素直に凄いですよね。")
Post.create('user_id' => '3', 'title' => '【参考になる】服のデザインの考え方・服の描き方', 'url' => 'https://www.youtube.com/watch?v=en03UW4fmpk',
            'category_list' => %w[知識 技術], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー アニメーター 絵本作家], 'target_list' => ['初心者', '中級者', '小学生以下', '中学・高校生', '専門・大学生', '社会人'], 'content' => "やっぱりただただ描くのではなく、考えながら描くことが非常に大事なのだと改めて教わる動画でした。\r\n\r\n自分自身の描ける服のレパートリーを少しずつでも増やしていけるように頑張りたいですね。")
Post.create('user_id' => '3', 'title' => '漫画家になるにはまず【漫画家志望者の末路】を知ろう。漫画家はギャンプルなのか？',
            'url' => 'https://www.youtube.com/watch?v=lhNeFq_B3ME', 'category_list' => %w[知識 メンタル], 'occupation_list' => ['漫画家'], 'target_list' => ['初心者', '中学・高校生', '専門・大学生'], 'content' => "SNSで誰でもインターネット上に漫画を発信できる時代だからこその利点をしっかり解説してくれています。\r\n\r\n漫画家志望の方には、心に突き刺さる動画になるのではないでしょうか!?")
Post.create('user_id' => '6', 'title' => '沢山絵を描いてるのに、練習してるのに上達しないと悩んでいる方へ',
            'url' => 'https://www.youtube.com/watch?v=3UZD14iPG8A', 'category_list' => %w[知識 技術 メンタル], 'occupation_list' => %w[漫画家 イラストレーター キャラクターデザイナー コンセプトアーティスト アニメーター 絵本作家], 'target_list' => ['中級者', '小学生以下', '専門・大学生', '社会人'], 'content' => "有名な絵師の方はやっぱりかなりの時間を絵に費やした結果なんですよね。\r\n\r\nスランプを払拭できる動画です。")
...
Notification.create(visitor_id: 5, visited_id: 1, post_id: 8, action: 'like', checked: true)
Notification.create(visitor_id: 2, visited_id: 1, post_id: 2, action: 'like', checked: true)
Notification.create(visitor_id: 3, visited_id: 1, action: 'follow', checked: true)
Notification.create(visitor_id: 4, visited_id: 1, action: 'follow', checked: true)
Notification.create(visitor_id: 6, visited_id: 1, post_id: 8, action: 'like', checked: true)
Notification.create(visitor_id: 2, visited_id: 1, post_id: 2, comment_id: 28, action: 'comment', checked: true)
Notification.create(visitor_id: 5, visited_id: 1, action: 'follow', checked: true)
Notification.create(visitor_id: 3, visited_id: 1, post_id: 13, action: 'like', checked: true)
Notification.create(visitor_id: 5, visited_id: 1, post_id: 2, comment_id: 29, action: 'comment', checked: true)
Notification.create(visitor_id: 8, visited_id: 1, post_id: 8, action: 'like', checked: true)
Notification.create(visitor_id: 7, visited_id: 1, action: 'follow', checked: true)
Notification.create(visitor_id: 7, visited_id: 1, post_id: 8, comment_id: 30, action: 'comment', checked: true)
Notification.create(visitor_id: 5, visited_id: 1, post_id: 13, action: 'like', checked: true)
Notification.create(visitor_id: 2, visited_id: 1, post_id: 9, comment_id: 33, action: 'comment', checked: true)
Notification.create(visitor_id: 3, visited_id: 1, post_id: 8, action: 'like', checked: true)
Notification.create(visitor_id: 6, visited_id: 1, post_id: 2, action: 'like', checked: true)
Notification.create(visitor_id: 6, visited_id: 1, post_id: 16, comment_id: 34, action: 'comment', checked: true)
Notification.create(visitor_id: 5, visited_id: 1, post_id: 2, action: 'like', checked: true)
Notification.create(visitor_id: 8, visited_id: 1, action: 'follow', checked: true)
